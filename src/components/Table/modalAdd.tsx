...
const Adicionar  = ({ closeModal, open }) => {
  const [activeTab, setActiveTab] = useState<'Editar' | 'Atividade'>('Editar');
  const [activities, setActivities] = useState<Array<{ name: string; time: string; image: string }>>([
    ...
    <div className="lead-modal" onClick={handleModalClick}>
      ...
      <div className="modal-header">
          <div className="modal-tabs">
              ...
              <button className={activeTab === 'Atividade' ? 'active' : ''} onClick={() => setActiveTab('Atividade')}>
      ...
      <div className="modal-content">
        {/* {activeTab === 'Editar' && ( */}
            ...
            <label>Cliente</label>
            <input type="text" placeholder="Café dois irmãos"/>
            ...
            <input type="text" placeholder="Rua Pedro Almeira, 25, sala 302 | CEP"/>
            ...
            <div className="comentario-container">
              <input type="text" className="comentario-input" placeholder="Escreva um comentário"/>
              <button className="blue-button">Atualizar</button>
            </div>
{/* 
                 ...
                 <div className="activity-section">
                      {activities.map((activity, index) => (
                          <div key={index} className="activity-item">
                                  <img src={activity.image} alt={`Imagem de ${activity.name}`} />
