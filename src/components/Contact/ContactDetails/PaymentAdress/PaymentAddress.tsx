...
export default function PaymentAddress({ address }) {
  return (
    <div className="index">
                  ...
                  <div className="accordion-collapse" key={key}>
                    <div className="text-6">
                      <div className="row-4">
                        ...
                        {addr.isMain ? <span className="badge-3">{addr.name}</span> : ''}
                      </div>
                      <p className="text-wrapper-21">{`${addr.street}, ${addr.number}, ${addr.district}, ${addr.city} - ${addr.state}`}</p>
                    </div>
